...
function updateIndex(){
    ...
    function remsLogin(data) {
        ...
        //if(data[0].login === 'true') localJsonp.start({url:'jsonp/gislist.js', jsonpCallback: 'gislist',done:indexInit}); // 登录成功加载项目
         localJsonp.start({url:'jsonp/gislist.js', jsonpCallback: 'gislist',done:indexInit}); // 登录成功加载项目
        //else alert('数据库出错')
    }
}
...
*/
			...
			$("#index_right_swiper").on("click", ".swiper-slide", function(e) {
				...
				//bdmap.centerAndZoom(point,1); //地图的缩放比
...
dateAllShow(); // show all datepicker
    ...
    .on("click", "#showModal_8",function() {
      ...
      dateDay.parents('.selector').hide();
        ...
        costFn(["jsonp/mainfinanceY02.js","mainfinanceY02"],["jsonp/financePieY02.js","financePieY02"],["jsonp/financePieY03.js","financePieY03"],0);
      ...
      dateDay.parents('.selector').hide();
		...
		function show_5_callback() {
            ...
            costFn(["jsonp/mainfinanceM02.js","mainfinanceM02"],["jsonp/financePieM02.js","financePieM02"],["jsonp/financePieM03.js","financePieM03"],1);
		}
      ...
      dateDay.parents('.selector').show();
            ...
            costFn(["jsonp/mainfinanceD02.js","mainfinanceD02"],["jsonp/financePieD02.js","financePieD02"],["jsonp/financePieD03.js","financePieD03"],2);
            /*
			var URLS = [["http://10.36.128.73:8080/reds/ds/","mainfinance"],["http://10.36.128.73:8080/reds/ds/","financePie"],["http://10.36.128.73:8080/reds/ds/","financePie"]];
			$modalinnerChartWrap.data({
				"chartType":"1",
                ...
                function selectDate(type, pid, joinDate, unitname) {//弹出框多态
                    switch(type) {
                        ...
                        case 'nine':
                            ...
                            costFn(["jsonp/mainfinanceM02.js","mainfinanceM02"],["jsonp/financePieM02.js","financePieM02"],["jsonp/financePieM02.js","financePieM02"],1);
                            break;
                        case 'ten':
                            ...
                            costFn(["jsonp/mainfinanceD02.js","mainfinanceD02"],["jsonp/financePieD02.js","financePieD02"],["jsonp/financePieD03.js","financePieD02"],2);
                            break;
                        case 'eleven':
